 ...
 */
final class Version20220608152320 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE `order` (id INT AUTO_INCREMENT NOT NULL, symbol VARCHAR(16) NOT NULL, exchange VARCHAR(16) NOT NULL, quantity DOUBLE PRECISION NOT NULL, price DOUBLE PRECISION NOT NULL, status VARCHAR(16) NOT NULL, profit DOUBLE PRECISION DEFAULT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX ix_price_datetime_symbol (symbol, status, exchange), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE price (id INT AUTO_INCREMENT NOT NULL, datetime DATETIME NOT NULL, price DOUBLE PRECISION NOT NULL, symbol VARCHAR(16) NOT NULL, exchange VARCHAR(16) NOT NULL, INDEX ix_price_datetime_symbol (datetime, symbol), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
